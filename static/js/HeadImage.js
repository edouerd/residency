...
function HeadImage(className){
    ...
    this.imageLeft = $("."+this.className+">.z-0").offset().left;
    this.imageRight = this.imageLeft + $("."+this.className+">.z-0").width();
    this.imageTop = $("."+this.className+">.z-0").offset().top;
    this.imageBottom = this.imageTop + $("."+this.className+">.z-0").height();
